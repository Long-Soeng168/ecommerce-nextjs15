            ...
            <div className="flex w-[200px] border-gray-300">
              <span className="z-50 text-destructive translate-x-[0.5px] border-[0.5px] border-primary">
                <Select defaultValue="percentage">
                  <SelectTrigger className="w-auto mx-0 border-none rounded-none shadow-none">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <input
                type="number"
                id="received-dollar"
                className="w-full border-[0.5px] border-primary h-full text-lg text-red-600 outline-none text-end no-spinner "
                placeholder="0.00"
              />
            </div>
          </div>
